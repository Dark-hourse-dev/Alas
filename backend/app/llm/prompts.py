...
def build_system_prompt(mode: str = "casual", user_context: str = "") -> str:
    ...
    parts.extend([
        ...
        "",
        "[FILE OPERATIONS]: You have access to local files via MCP filesystem tools (`read_file`, `write_file`, `list_directory`, etc).",
        "CRITICAL: All file tools require ABSOLUTE PATHS. Do not use relative paths.",
        "Your current workspace root is: /home/himanshu-meena/workspace",
        "",
